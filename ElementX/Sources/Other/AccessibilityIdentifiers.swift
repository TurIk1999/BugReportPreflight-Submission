...
enum A11yIdentifiers {
    ...
    struct BugReportPreflightScreen {
        let summary = "bug_report_preflight-summary"
        let stepsToReproduce = "bug_report_preflight-steps_to_reproduce"
        let expectedBehavior = "bug_report_preflight-expected_behavior"
        let actualBehavior = "bug_report_preflight-actual_behavior"
        let diagnostics = "bug_report_preflight-diagnostics"
        let copyToClipboard = "bug_report_preflight-copy_to_clipboard"
